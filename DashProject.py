...
# Standardize league names for the origin club by replacing hyphens and applying title case
if 'league_name_from' in master_df.columns:
    master_df['league_name_from'] = master_df['league_name_from'].str.replace('-', ' ').str.title()
else:
    print("Warning: 'league_name_from' column not found in master_df.")
